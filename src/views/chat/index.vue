        ...
        <div class="w-full max-w-screen-xl m-auto dark:bg-[#101014]" :class="[isMobile ? 'p-2' : 'p-4']">
          <div id="image-wrapper" class="relative">
            ...
            <template v-else>
              <div>
                <Message
                  v-for="(item, index) of dataSources" :key="index" v-model:text="item.text"
                  :date-time="item.dateTime" :inversion="item.inversion" :error="item.error" :loading="item.loading"
                  @edit-submit="onEdit($event, index)" @regenerate="onRegenerate(index)"
